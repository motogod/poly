...
import { useContractForRead, useUtility, useBaseUrl, useSendTokens, useQRCodeModal } from '@/hooks';
...
function useDepositUsdtModal() {
	...
	}, [isCopied, ethValue, inputValue, isShowInputLayout, proxyWallet, modalOnOpen]);
